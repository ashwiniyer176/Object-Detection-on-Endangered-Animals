...
if os.name=='nt':
    ...
    os.system(f"unzip protoc-3.15.6-win64.zip && tar cvf protoc-3.15.6-win64.tar ./include/ ") #&& tar -xf protoc-3.15.6-win64.tar")
...
os.system(f"python {files['TF_RECORD_SCRIPT']} -x {os.path.join(paths['IMAGE_PATH'], 'train')} -l {files['LABELMAP']} -o {os.path.join(paths['ANNOTATION_PATH'], 'train.record')} -c {os.path.join(paths['ANNOTATION_PATH'], 'sample.csv')}")
